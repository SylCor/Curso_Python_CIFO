...
class GestionPrestamos:
    ...
    def menu_prestamos(self):
        while True:
            ...
            print("5: Generar JSON de todos los prestamos")
            ...
            if opcion == "5":
                utils.exportar_json(self.prestamosDB,"prestamos.json")
                print("Se ha generado el archivo JSON con todos los prestamos")
