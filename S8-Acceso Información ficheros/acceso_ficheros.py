...
with open("archivos/saludos.txt", "w") as file:
    file.write("Hola mundo\n")
    file.write("Hello world\n")
    
# Crear y escribir en un archivo de texto (en carpeta creada desde Pythin)
...
with open("archivos_python/datos.csv", "w", newline="") as file:
    ...
    writer.writerow(["Sylvia", "Caracas"])
    writer.writerow(["John", "Maracaibo"])
    writer.writerow(["Gabiela", "Barcelona"])
...
# validad si existe un titulo de libro en la database
